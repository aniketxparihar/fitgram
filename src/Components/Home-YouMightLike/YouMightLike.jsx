  ...
  return (
    ...
    >
      ...
      <div className="who-to-follow__profile flex justify-center align-center mb-4">
        ...
        <div className="follow h-12 w-24 bg-violet-100 hover:bg-violet-400 cursor-pointer font-bold flex justify-center items-center rounded-full">
          Follow
        </div>
      </div>
      ...
      <div className="show-more text-violet-500 text-xl text mb-4 cursor-pointer">
        Show More
      </div>
    </div>
  );
