  ...
  return (
    ...
    >
      ...
      <div className="new-post__options">
        ...
        <button disabled={newPostContent.length<1} className="add-post w-32 text-xl font-bold  bg-violet-700 text-gray-50 rounded-3xl cursor-pointer" onClick={() => {
          addPost({ content:newPostContent, media:newPostMedia}, authToken);
